...
with col2:
    st.image('https://images.unsplash.com/photo-1499951360447-b19be8fe80f5', width=120)
...
if selected in mbti_data:
    ...
    with left_col:
        ...
        st.subheader(f"{selected} — {data['설명']}")
        st.write("**추천 직업 (다양한 분야):**")
        for j in data['직업']:
            st.write(f"- {j}")
